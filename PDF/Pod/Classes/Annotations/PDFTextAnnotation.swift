...
//  Pods
//
//  Created by Arun Jadhav on 07/22/196.
//
//
...
extension PDFTextAnnotation: PDFAnnotation {
    ...
    public func touchEnded(_ touch: UITouch, point: CGPoint) {
        ...
        if text != ""
        {
        let parameters: Parameters = ["lineDetails":["points":[[0,0]]],"textDetails":["points":[rect.minX,rect.minY],"fontSize":14,"text":text]]
...
extension PDFTextAnnotation: UITextViewDelegate {
    ...
    public func textViewDidEndEditing(_ textView: UITextView) {
        ...
        print("Text annotation text is here :",textView.text!)
        print("Text annotation text is here :",rect)
    }
}
